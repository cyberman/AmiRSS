...
/*
**  $VER: TheBar_mcc.h 17.0 (3.3.2004)
**  Includes Release 17.0
**
**  (C) Copyright 2003-2004 Alfonso [alfie] Ranieri <alforan@tin.it>
**      All rights reserved
*/
...
#define THEBAR_VERSION     17
#define THEBARVIRT_VERSION 17
#define THEBUTTON_VERSION  17
